	...
	<table align="center" border="0">
		...
		?>
                   ...
                   <td class="tensp_hienthi_sp">
                    ...
                    <td class="active_hienthi_sp"><a href="?admin=suadm&madm=<?php echo $bien['madm']?>" > <img src="img/sua.png" title="Sửa" style="width:30px;height:30px;" /></a>
					<?php echo "<p onclick = 'checkdel({$bien['madm'] })' ><img src='img/xoa.png' title='Xóa' class='delete' style='width:30px;height:30px;' ></p>" ?>
                   </td>
...
<script language="JavaScript">
    ...
    {
        var	madm=madm;
        var link="admin.php?admin=xoadm&madm="+madm;
