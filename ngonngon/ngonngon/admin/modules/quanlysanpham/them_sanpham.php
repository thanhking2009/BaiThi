...
<?php
	...
	//	$hinhanh=$_POST['hinhanh'];
		...
		$madm=$_POST['madm'];
		$insert="INSERT INTO sanpham (tensp,hinhanh,chitiet,soluong,gia,madm) VALUES('$ten_sanpham', '$file__name__', '$chitiet', '$soluong', '$gia', '$madm')";
      ...
      <table>
            ...
            <tr>
            	<td>Mã DM</td><td>
                    ...
                    <?php
						$show = mysqli_query($conn,"SELECT * FROM danhmuc");
