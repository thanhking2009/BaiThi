...
<a href='?admin=themsp' >Thêm sản phẩm</a><br>
	...
	<td><form action="admin.php?admin=xulysp" method="post">
		<div id="check">
			<p>
...
?>
            <tr class='noidung_hienthi_sp'>
                ...
                <td class="active_hienthi_sp">
                    <a href='admin.php?admin=suasp&idsp=<?php echo $bien['idsp']  ?>'><img src="img/sua.png" title="Sửa" style="width:30px;height:30px;"></a>
				</td>
            </tr>
<?php 
    }
...
?>
	...
	<?php
			...
			$total_results = mysqli_num_rows(mysqli_query($conn,"SELECT * FROM sanpham"));  
